<script lang="ts">
    ...
    import { getSeasonStats } from '../../lib/services/statsService'
    import { getImageUrl } from '../../lib/utils/images'

    let selectedSeason = 'Hawks-Jazz-1'
    let players = []
    let teamA = []
    let teamB = []
    let selectedA = null
...
<div class="min-h-screen bg-[#000536] text-white p-8 space-y-10">
    <h1 class="text-4xl font-bold text-center mb-6">Team Player Comparison</h1>
